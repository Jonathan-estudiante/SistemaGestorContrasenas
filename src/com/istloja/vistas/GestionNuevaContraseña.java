...
public class GestionNuevaContraseña {
    ...
    public GestionNuevaContraseña(JPasswordField jtxt_contraseña, JPasswordField jtxt_repetirContraseña, JComboBox jcb_tipoContraseña, JTextField nombre_SitioApp, JTextField jtxt_propietario, Utilidades utilidades, JFrame frameGestionContable) {
    ...
    public NuevaContraseña guardarEditarContraseña(boolean isEditar) {
        ...
        NuevaContraseña contraseña = new NuevaContraseña();
        contraseña.setContraseña(utilidades.encriptar(jtxt_contraseña.getText().trim()));
        contraseña.setTipoContraseña(String.valueOf(jcb_tipoContraseña.getSelectedItem().toString()));
        contraseña.setNombreSitioApp(nombre_SitioApp.getText());
        contraseña.setPropietario(jtxt_propietario.getText());

        if (isEditar) {
            contraseña.setFechaActualizacion(new Date());
        } else {
            contraseña.setFechaRegistro(new Date());
        }
        return contraseña;
    }
}
