package com.istloja.placeholder;
...
public class TextPrompt1 extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public TextPrompt1(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public TextPrompt1(String text, JTextComponent component, Show show) {
